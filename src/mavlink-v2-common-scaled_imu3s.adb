...
package body MAVLink.V2.Common.Scaled_Imu3s is
   ...
   begin
      Last := Buffer'First +
        ...
        (Scaled_Imu3'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Scaled_Imu3_Id, 46, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Scaled_Imu3'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
...
end MAVLink.V2.Common.Scaled_Imu3s;
