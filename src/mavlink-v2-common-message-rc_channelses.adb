...
package body MAVLink.V2.Common.Message.Rc_Channelses is
   ...
   begin
      Last := Buffer'First +
        ...
        (Rc_Channels'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Rc_Channels_Id, 118, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Rc_Channels'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
...
end MAVLink.V2.Common.Message.Rc_Channelses;
