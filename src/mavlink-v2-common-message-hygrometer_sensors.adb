...
package body MAVLink.V2.Common.Message.Hygrometer_Sensors is
   ...
   procedure Encode
     (Message : Hygrometer_Sensor;
      ...
      Last    : out Positive)
   is
      Local : Data_Buffer (1 .. Hygrometer_Sensor'Value_Size / 8)
   ...
   begin
      Last := Buffer'First +
        ...
        (Hygrometer_Sensor'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Hygrometer_Sensor_Id, 20, Buffer, Last);
   end Encode;
   ...
   begin
      Last := Buffer'First +
        ...
        (Hygrometer_Sensor'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Hygrometer_Sensor_Id, 20, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Hygrometer_Sensor'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
        (1 .. Hygrometer_Sensor'Size / 8) := [others => 0]
