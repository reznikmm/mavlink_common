...
package body MAVLink.V2.Common.Local_Position_Neds is
   ...
   begin
      Last := Buffer'First +
        ...
        (Local_Position_Ned'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Local_Position_Ned_Id, 185, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Local_Position_Ned'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
...
end MAVLink.V2.Common.Local_Position_Neds;
