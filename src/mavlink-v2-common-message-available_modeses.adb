...
package body MAVLink.V2.Common.Message.Available_Modeses is
   ...
   procedure Encode
     (Message : Available_Modes;
      ...
      Last    : out Positive)
   is
      Local : Data_Buffer (1 .. Available_Modes'Value_Size / 8)
   ...
   begin
      Last := Buffer'First +
        ...
        (Available_Modes'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Available_Modes_Id, 134, Buffer, Last);
   end Encode;
   ...
   begin
      Last := Buffer'First +
        ...
        (Available_Modes'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Available_Modes_Id, 134, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Available_Modes'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
        (1 .. Available_Modes'Size / 8) := [others => 0]
