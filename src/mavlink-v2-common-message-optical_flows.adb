...
package body MAVLink.V2.Common.Message.Optical_Flows is
   ...
   begin
      Last := Buffer'First +
        ...
        (Optical_Flow'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Optical_Flow_Id, 175, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Optical_Flow'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
