...
package body MAVLink.V1.Common.Hil_Rc_Inputs_Raws is
   ...
   is
      Buf : Data_Buffer (1 .. Hil_Rc_Inputs_Raw'Size / 8)
        with Import,
        Address    => Message'Address,
        Convention => Ada;
   begin
      if Get_Msg_Len (Connect) =
        Unsigned_8 (Integer (Hil_Rc_Inputs_Raw'Value_Size) / 8)
      then
...
end MAVLink.V1.Common.Hil_Rc_Inputs_Raws;
