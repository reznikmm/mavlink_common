...
package body MAVLink.V2.Common.Message.Debug_Float_Arrays is
   ...
   procedure Encode
     (Message : Debug_Float_Array;
      ...
      Last    : out Positive)
   is
      Local : Data_Buffer (1 .. Debug_Float_Array'Value_Size / 8)
   ...
   begin
      Last := Buffer'First +
        ...
        (Debug_Float_Array'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Debug_Float_Array_Id, 232, Buffer, Last);
   end Encode;
   ...
   begin
      Last := Buffer'First +
        ...
        (Debug_Float_Array'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Debug_Float_Array_Id, 232, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Debug_Float_Array'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
        (1 .. Debug_Float_Array'Size / 8) := [others => 0]
