...
package body MAVLink.V2.Common.Mission_Items is
   ...
   begin
      Last := Buffer'First +
        ...
        (Mission_Item'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Mission_Item_Id, 254, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Mission_Item'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
...
end MAVLink.V2.Common.Mission_Items;
