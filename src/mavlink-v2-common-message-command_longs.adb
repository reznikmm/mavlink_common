...
package body MAVLink.V2.Common.Message.Command_Longs is
   ...
   begin
      Last := Buffer'First +
        ...
        (Command_Long'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Command_Long_Id, 152, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Command_Long'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
