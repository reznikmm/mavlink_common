...
package body MAVLink.V2.Common.Link_Node_Statuses is
   ...
   begin
      Last := Buffer'First +
        ...
        (Link_Node_Status'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Link_Node_Status_Id, 117, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Link_Node_Status'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
...
end MAVLink.V2.Common.Link_Node_Statuses;
