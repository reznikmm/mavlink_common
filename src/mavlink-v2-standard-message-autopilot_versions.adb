...
package body MAVLink.V2.Standard.Message.Autopilot_Versions is
   ...
   begin
      Last := Buffer'First +
        ...
        (Autopilot_Version'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Autopilot_Version_Id, 178, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Autopilot_Version'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
