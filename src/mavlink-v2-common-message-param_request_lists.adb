...
package body MAVLink.V2.Common.Message.Param_Request_Lists is
   ...
   begin
      Last := Buffer'First +
        ...
        (Param_Request_List'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Param_Request_List_Id, 159, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Param_Request_List'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
...
end MAVLink.V2.Common.Message.Param_Request_Lists;
