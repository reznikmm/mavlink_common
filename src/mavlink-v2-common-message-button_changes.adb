...
package body MAVLink.V2.Common.Message.Button_Changes is
   ...
   procedure Encode
     (Message : Button_Change;
      ...
      Last    : out Positive)
   is
      Local : Data_Buffer (1 .. Button_Change'Value_Size / 8)
   ...
   begin
      Last := Buffer'First +
        ...
        (Button_Change'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Button_Change_Id, 131, Buffer, Last);
   end Encode;
   ...
   begin
      Last := Buffer'First +
        ...
        (Button_Change'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Button_Change_Id, 131, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Button_Change'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
        (1 .. Button_Change'Size / 8) := [others => 0]
