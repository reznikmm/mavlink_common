...
package body MAVLink.V2.Common.Optical_Flow_Rads is
   ...
   begin
      Last := Buffer'First +
        ...
        (Optical_Flow_Rad'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Optical_Flow_Rad_Id, 138, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Optical_Flow_Rad'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
...
end MAVLink.V2.Common.Optical_Flow_Rads;
