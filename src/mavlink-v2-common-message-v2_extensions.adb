...
package body MAVLink.V2.Common.Message.V2_Extensions is
   ...
   begin
      Last := Buffer'First +
        ...
        (V2_Extension'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, V2_Extension_Id, 8, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. V2_Extension'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
...
end MAVLink.V2.Common.Message.V2_Extensions;
