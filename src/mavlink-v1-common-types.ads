...
package MAVLink.V1.Common.Types is
   ...
   function Type_Unsupported return Mav_Param_Error is (6)
     with Static;
   --  Parameter data type (MAV_PARAM_TYPE) is not supported by flight stack
   --  (at all)

   function Type_Mismatch return Mav_Param_Error is (7)
     with Static;
   --  Parameter type does not match expected type

   function Read_Fail return Mav_Param_Error is (8)
     with Static;
   ...
   function Well_Known_Image
     (Value : Mav_Param_Error_Well_Known) return String is
       (case Value is
        ...
        when Type_Unsupported => "Type_Unsupported",
        when Type_Mismatch => "Type_Mismatch",
        when Read_Fail => "Read_Fail");
   ...
   type Mav_Fuel_Type is new Interfaces.Unsigned_8;
   ...
   type Mav_Tunnel_Payload_Type is new Interfaces.Unsigned_8;
   ...
   type Tune_Format is new Interfaces.Unsigned_8;
