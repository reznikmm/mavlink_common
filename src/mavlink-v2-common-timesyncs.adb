...
package body MAVLink.V2.Common.Timesyncs is
   ...
   begin
      Last := Buffer'First +
        ...
        (Timesync'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Timesync_Id, 34, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Timesync'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
...
end MAVLink.V2.Common.Timesyncs;
