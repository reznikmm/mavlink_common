...
package body MAVLink.V2.Common.Log_Datas is
   ...
   begin
      Last := Buffer'First +
        ...
        (Log_Data'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Log_Data_Id, 134, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Log_Data'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
...
end MAVLink.V2.Common.Log_Datas;
