...
package body MAVLink.V2.Common.Message.Mission_Set_Currents is
   ...
   begin
      Last := Buffer'First +
        ...
        (Mission_Set_Current'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Mission_Set_Current_Id, 28, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Mission_Set_Current'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
