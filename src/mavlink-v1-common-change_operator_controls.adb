...
package body MAVLink.V1.Common.Change_Operator_Controls is
   ...
   is
      Buf : Data_Buffer (1 .. Change_Operator_Control'Size / 8)
        with Import,
        Address    => Message'Address,
        Convention => Ada;
   begin
      if Get_Msg_Len (Connect) =
        Unsigned_8 (Integer (Change_Operator_Control'Value_Size) / 8)
      then
...
end MAVLink.V1.Common.Change_Operator_Controls;
