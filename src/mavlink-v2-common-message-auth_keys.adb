...
package body MAVLink.V2.Common.Message.Auth_Keys is
   ...
   begin
      Last := Buffer'First +
        ...
        (Auth_Key'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Auth_Key_Id, 119, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Auth_Key'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
...
end MAVLink.V2.Common.Message.Auth_Keys;
