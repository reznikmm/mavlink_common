...
package body MAVLink.V1.Common.Servo_Output_Raws is
   ...
   is
      Buf : Data_Buffer (1 .. Servo_Output_Raw'Size / 8)
        with Import,
        Address    => Message'Address,
        Convention => Ada;
   begin
      if Get_Msg_Len (Connect) =
        Unsigned_8 (Integer (Servo_Output_Raw'Value_Size) / 8)
      then
...
end MAVLink.V1.Common.Servo_Output_Raws;
