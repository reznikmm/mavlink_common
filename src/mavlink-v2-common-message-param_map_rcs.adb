...
package body MAVLink.V2.Common.Message.Param_Map_Rcs is
   ...
   begin
      Last := Buffer'First +
        ...
        (Param_Map_Rc'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Param_Map_Rc_Id, 78, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Param_Map_Rc'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
...
end MAVLink.V2.Common.Message.Param_Map_Rcs;
