...
package body MAVLink.V2.Common.Manual_Setpoints is
   ...
   begin
      Last := Buffer'First +
        ...
        (Manual_Setpoint'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Manual_Setpoint_Id, 106, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Manual_Setpoint'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
...
end MAVLink.V2.Common.Manual_Setpoints;
