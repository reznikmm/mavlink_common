...
package body MAVLink.V2.Common.Att_Pos_Mocaps is
   ...
   begin
      Last := Buffer'First +
        ...
        (Att_Pos_Mocap'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Att_Pos_Mocap_Id, 109, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Att_Pos_Mocap'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
...
end MAVLink.V2.Common.Att_Pos_Mocaps;
