...
package body MAVLink.V2.Common.Terrain_Checks is
   ...
   begin
      Last := Buffer'First +
        ...
        (Terrain_Check'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Terrain_Check_Id, 203, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Terrain_Check'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
...
end MAVLink.V2.Common.Terrain_Checks;
