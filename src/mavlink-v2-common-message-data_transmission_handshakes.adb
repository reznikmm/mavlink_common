...
package body MAVLink.V2.Common.Message.Data_Transmission_Handshakes is
   ...
   begin
      Last := Buffer'First +
        ...
        (Data_Transmission_Handshake'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Data_Transmission_Handshake_Id, 29, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Data_Transmission_Handshake'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
