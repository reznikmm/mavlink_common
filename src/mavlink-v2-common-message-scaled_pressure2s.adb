...
package body MAVLink.V2.Common.Message.Scaled_Pressure2s is
   ...
   begin
      Last := Buffer'First +
        ...
        (Scaled_Pressure2'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Scaled_Pressure2_Id, 195, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Scaled_Pressure2'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
...
end MAVLink.V2.Common.Message.Scaled_Pressure2s;
