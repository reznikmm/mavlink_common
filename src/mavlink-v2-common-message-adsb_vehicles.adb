...
package body MAVLink.V2.Common.Message.Adsb_Vehicles is
   ...
   begin
      Last := Buffer'First +
        ...
        (Adsb_Vehicle'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Adsb_Vehicle_Id, 184, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Adsb_Vehicle'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
...
end MAVLink.V2.Common.Message.Adsb_Vehicles;
