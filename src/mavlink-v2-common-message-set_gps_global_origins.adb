...
package body MAVLink.V2.Common.Message.Set_Gps_Global_Origins is
   ...
   begin
      Last := Buffer'First +
        ...
        (Set_Gps_Global_Origin'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Set_Gps_Global_Origin_Id, 41, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Set_Gps_Global_Origin'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
