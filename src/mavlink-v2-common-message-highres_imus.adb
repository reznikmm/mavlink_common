...
package body MAVLink.V2.Common.Message.Highres_Imus is
   ...
   begin
      Last := Buffer'First +
        ...
        (Highres_Imu'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Highres_Imu_Id, 93, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Highres_Imu'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
...
end MAVLink.V2.Common.Message.Highres_Imus;
