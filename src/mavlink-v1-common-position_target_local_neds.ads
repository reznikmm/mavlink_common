...
package MAVLink.V1.Common.Position_Target_Local_Neds is

   pragma Pure;

   Position_Target_Local_Ned_Len : constant Interfaces.Unsigned_8 := 51;

   type Position_Target_Local_Ned is record
...
end MAVLink.V1.Common.Position_Target_Local_Neds;
