...
package body MAVLink.V1.Common.Set_Position_Target_Global_Ints is
   ...
   is
      Buf : Data_Buffer (1 .. Set_Position_Target_Global_Int'Size / 8)
        with Import,
...
end MAVLink.V1.Common.Set_Position_Target_Global_Ints;
