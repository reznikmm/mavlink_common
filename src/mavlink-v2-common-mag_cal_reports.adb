...
package body MAVLink.V2.Common.Mag_Cal_Reports is
   ...
   begin
      Last := Buffer'First +
        ...
        (Mag_Cal_Report'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Mag_Cal_Report_Id, 36, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Mag_Cal_Report'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
...
end MAVLink.V2.Common.Mag_Cal_Reports;
