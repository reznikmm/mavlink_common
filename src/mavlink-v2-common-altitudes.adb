...
package body MAVLink.V2.Common.Altitudes is
   ...
   begin
      Last := Buffer'First +
        ...
        (Altitude'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Altitude_Id, 47, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Altitude'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
...
end MAVLink.V2.Common.Altitudes;
