...
package body MAVLink.V2.Common.Message.Debugs is
   ...
   begin
      Last := Buffer'First +
        ...
        (Debug'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Debug_Id, 46, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Debug'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
...
end MAVLink.V2.Common.Message.Debugs;
