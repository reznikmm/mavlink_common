...
package body MAVLink.V2.Common.Home_Positions is
   ...
   begin
      Last := Buffer'First +
        ...
        (Home_Position'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Home_Position_Id, 104, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Home_Position'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
...
end MAVLink.V2.Common.Home_Positions;
