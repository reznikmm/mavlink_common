...
package body MAVLink.V2.Common.Set_Position_Target_Global_Ints is
   ...
   begin
      Last := Buffer'First +
        ...
        (Set_Position_Target_Global_Int'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Set_Position_Target_Global_Int_Id, 5, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Set_Position_Target_Global_Int'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
...
end MAVLink.V2.Common.Set_Position_Target_Global_Ints;
