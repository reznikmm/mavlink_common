...
package body MAVLink.V2.Common.Command_Ints is
   ...
   begin
      Last := Buffer'First +
        ...
        (Command_Int'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Command_Int_Id, 158, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Command_Int'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
...
end MAVLink.V2.Common.Command_Ints;
