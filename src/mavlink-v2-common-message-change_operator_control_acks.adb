...
package body MAVLink.V2.Common.Message.Change_Operator_Control_Acks is
   ...
   begin
      Last := Buffer'First +
        ...
        (Change_Operator_Control_Ack'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Change_Operator_Control_Ack_Id, 104, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Change_Operator_Control_Ack'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
...
end MAVLink.V2.Common.Message.Change_Operator_Control_Acks;
