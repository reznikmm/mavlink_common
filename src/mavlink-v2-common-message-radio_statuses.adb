...
package body MAVLink.V2.Common.Message.Radio_Statuses is
   ...
   begin
      Last := Buffer'First +
        ...
        (Radio_Status'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Radio_Status_Id, 185, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Radio_Status'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
...
end MAVLink.V2.Common.Message.Radio_Statuses;
