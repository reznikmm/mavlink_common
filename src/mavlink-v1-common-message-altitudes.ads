...
package Mavlink.V1.Common.Message.Altitudes is

   pragma Preelaborate;

   Altitude_Id : constant Msg_Id := 141;

   Altitude_Len : constant Interfaces.Unsigned_8 := 32;
   ...
   type Altitude is record
      ...
      Altitude_Monotonic : Interfaces.IEEE_Float_32;
      --  Units: [m]
      ...
      Altitude_Amsl      : Interfaces.IEEE_Float_32;
      --  Units: [m]
      ...
      Altitude_Local     : Interfaces.IEEE_Float_32;
      --  Units: [m]
      ...
      Bottom_Clearance   : Interfaces.IEEE_Float_32;
      --  Units: [m]
