...
package body MAVLink.V1.Common.Attitude_Quaternions is
   ...
   is
      Buf : Data_Buffer (1 .. Attitude_Quaternion'Size / 8)
        with Import,
        Address    => Message'Address,
        Convention => Ada;
   begin
      if Get_Msg_Len (Connect) =
        Unsigned_8 (Integer (Attitude_Quaternion'Value_Size) / 8)
      then
...
end MAVLink.V1.Common.Attitude_Quaternions;
