...
package body MAVLink.V2.Common.Message.Set_Home_Positions is
   ...
   begin
      Last := Buffer'First +
        ...
        (Set_Home_Position'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Set_Home_Position_Id, 85, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Set_Home_Position'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
...
end MAVLink.V2.Common.Message.Set_Home_Positions;
