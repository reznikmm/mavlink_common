...
package body MAVLink.V2.Common.Distance_Sensors is
   ...
   begin
      Last := Buffer'First +
        ...
        (Distance_Sensor'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Distance_Sensor_Id, 85, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Distance_Sensor'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
...
end MAVLink.V2.Common.Distance_Sensors;
