...
package body MAVLink.V1.Common.Data_Transmission_Handshakes is
   ...
   is
      Buf : Data_Buffer (1 .. Data_Transmission_Handshake'Size / 8)
        with Import,
...
end MAVLink.V1.Common.Data_Transmission_Handshakes;
