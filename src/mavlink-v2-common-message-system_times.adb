...
package body MAVLink.V2.Common.Message.System_Times is
   ...
   begin
      Last := Buffer'First +
        ...
        (System_Time'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, System_Time_Id, 137, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. System_Time'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
...
end MAVLink.V2.Common.Message.System_Times;
