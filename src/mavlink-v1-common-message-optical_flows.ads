...
package MAVLink.V1.Common.Message.Optical_Flows is

   pragma Preelaborate;

   Optical_Flow_Id : constant Msg_Id := 100;

   Optical_Flow_Len : constant Interfaces.Unsigned_8 := 26;
   ...
   type Optical_Flow is record
      ...
      Flow_Comp_M_X   : Interfaces.IEEE_Float_32;
      --  Units: [m/s]
      --  Flow in x-sensor direction, angular-speed compensated 
      Flow_Comp_M_Y   : Interfaces.IEEE_Float_32;
      --  Units: [m/s]
      --  Flow in y-sensor direction, angular-speed compensated 
      Quality         : Interfaces.Unsigned_8;
      --  Optical flow quality / confidence. 0: bad, 255: maximum quality 
      Ground_Distance : Interfaces.IEEE_Float_32;
      --  Units: [m]
