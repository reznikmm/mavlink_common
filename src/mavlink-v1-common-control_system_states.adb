...
package body MAVLink.V1.Common.Control_System_States is
   ...
   is
      Buf : Data_Buffer (1 .. Control_System_State'Size / 8)
        with Import,
        Address    => Message'Address,
        Convention => Ada;
   begin
      if Get_Msg_Len (Connect) =
        Unsigned_8 (Integer (Control_System_State'Value_Size) / 8)
      then
