...
package body MAVLink.V2.Common.Airspeeds is
   ...
   procedure Encode
     (Message : Airspeed;
      ...
      Last    : out Positive)
   is
      Local : Data_Buffer (1 .. Airspeed'Value_Size / 8)
   ...
   begin
      Last := Buffer'First +
        ...
        (Airspeed'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Airspeed_Id, 234, Buffer, Last);
   end Encode;
   ...
   begin
      Last := Buffer'First +
        ...
        (Airspeed'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Airspeed_Id, 234, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Airspeed'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
        (1 .. Airspeed'Size / 8) := [others => 0]
