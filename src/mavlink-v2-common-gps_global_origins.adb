...
package body MAVLink.V2.Common.Gps_Global_Origins is
   ...
   begin
      Last := Buffer'First +
        ...
        (Gps_Global_Origin'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Gps_Global_Origin_Id, 39, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Gps_Global_Origin'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
...
end MAVLink.V2.Common.Gps_Global_Origins;
