...
package body MAVLink.V2.Common.Vision_Position_Estimates is
   ...
   begin
      Last := Buffer'First +
        ...
        (Vision_Position_Estimate'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Vision_Position_Estimate_Id, 158, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Vision_Position_Estimate'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
...
end MAVLink.V2.Common.Vision_Position_Estimates;
