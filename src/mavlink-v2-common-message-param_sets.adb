...
package body MAVLink.V2.Common.Message.Param_Sets is
   ...
   begin
      Last := Buffer'First +
        ...
        (Param_Set'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Param_Set_Id, 168, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Param_Set'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
...
end MAVLink.V2.Common.Message.Param_Sets;
