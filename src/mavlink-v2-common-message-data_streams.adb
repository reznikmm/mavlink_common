...
package body MAVLink.V2.Common.Message.Data_Streams is
   ...
   procedure Encode
     (Message : Data_Stream;
      ...
      Last    : out Positive)
   is
      Local : Data_Buffer (1 .. Data_Stream'Value_Size / 8)
   ...
   begin
      Last := Buffer'First +
        ...
        (Data_Stream'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Data_Stream_Id, 21, Buffer, Last);
   end Encode;
   ...
   begin
      Last := Buffer'First +
        ...
        (Data_Stream'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Data_Stream_Id, 21, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Data_Stream'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
        (1 .. Data_Stream'Size / 8) := [others => 0]
