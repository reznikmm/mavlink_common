...
package body MAVLink.V1.Common.Mission_Request_Partial_Lists is
   ...
   is
      Buf : Data_Buffer (1 .. Mission_Request_Partial_List'Size / 8)
        with Import,
...
end MAVLink.V1.Common.Mission_Request_Partial_Lists;
