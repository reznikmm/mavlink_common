...
package body MAVLink.V2.Common.Hil_Sensors is
   ...
   begin
      Last := Buffer'First +
        ...
        (Hil_Sensor'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Hil_Sensor_Id, 108, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Hil_Sensor'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
...
end MAVLink.V2.Common.Hil_Sensors;
