...
package body MAVLink.V2.Common.Message.Mission_Request_Partial_Lists is
   ...
   begin
      Last := Buffer'First +
        ...
        (Mission_Request_Partial_List'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Mission_Request_Partial_List_Id, 212, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Mission_Request_Partial_List'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
...
end MAVLink.V2.Common.Message.Mission_Request_Partial_Lists;
