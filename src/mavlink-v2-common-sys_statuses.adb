...
package body MAVLink.V2.Common.Sys_Statuses is
   ...
   begin
      Last := Buffer'First +
        ...
        (Sys_Status'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Sys_Status_Id, 124, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Sys_Status'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
...
end MAVLink.V2.Common.Sys_Statuses;
