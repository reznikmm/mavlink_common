...
with MAVLink.V1.Standard.Types; use MAVLink.V1.Standard.Types;

package MAVLink.V1.Standard.Autopilot_Versions is

   pragma Pure;

   Autopilot_Version_Len : constant Interfaces.Unsigned_8 := 60;
...
end MAVLink.V1.Standard.Autopilot_Versions;
