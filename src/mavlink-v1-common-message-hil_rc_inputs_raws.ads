...
package MAVLink.V1.Common.Message.Hil_Rc_Inputs_Raws is

   pragma Preelaborate;

   Hil_Rc_Inputs_Raw_Id : constant Msg_Id := 92;

   Hil_Rc_Inputs_Raw_Len : constant Interfaces.Unsigned_8 := 33;
...
end MAVLink.V1.Common.Message.Hil_Rc_Inputs_Raws;
