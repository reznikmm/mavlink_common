...
package body MAVLink.V2.Common.Attitude_Targets is
   ...
   begin
      Last := Buffer'First +
        ...
        (Attitude_Target'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Attitude_Target_Id, 22, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Attitude_Target'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
...
end MAVLink.V2.Common.Attitude_Targets;
