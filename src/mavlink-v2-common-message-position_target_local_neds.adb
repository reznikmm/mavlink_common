...
package body MAVLink.V2.Common.Message.Position_Target_Local_Neds is
   ...
   begin
      Last := Buffer'First +
        ...
        (Position_Target_Local_Ned'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Position_Target_Local_Ned_Id, 140, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Position_Target_Local_Ned'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
...
end MAVLink.V2.Common.Message.Position_Target_Local_Neds;
