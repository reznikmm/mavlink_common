...
package body MAVLink.V2.Minimal.Message.Heartbeats is
   ...
   begin
      Last := Buffer'First +
        ...
        (Heartbeat'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Heartbeat_Id, 50, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Heartbeat'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
...
end MAVLink.V2.Minimal.Message.Heartbeats;
