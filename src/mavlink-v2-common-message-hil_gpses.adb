...
package body MAVLink.V2.Common.Message.Hil_Gpses is
   ...
   begin
      Last := Buffer'First +
        ...
        (Hil_Gps'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Hil_Gps_Id, 124, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Hil_Gps'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
...
end MAVLink.V2.Common.Message.Hil_Gpses;
