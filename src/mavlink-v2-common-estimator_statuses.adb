...
package body MAVLink.V2.Common.Estimator_Statuses is
   ...
   begin
      Last := Buffer'First +
        ...
        (Estimator_Status'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Estimator_Status_Id, 163, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Estimator_Status'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
...
end MAVLink.V2.Common.Estimator_Statuses;
