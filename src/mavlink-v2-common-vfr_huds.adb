...
package body MAVLink.V2.Common.Vfr_Huds is
   ...
   begin
      Last := Buffer'First +
        ...
        (Vfr_Hud'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Vfr_Hud_Id, 20, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Vfr_Hud'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
...
end MAVLink.V2.Common.Vfr_Huds;
