...
package body MAVLink.V2.Common.Message.Request_Data_Streams is
   ...
   begin
      Last := Buffer'First +
        ...
        (Request_Data_Stream'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Request_Data_Stream_Id, 148, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Request_Data_Stream'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
...
end MAVLink.V2.Common.Message.Request_Data_Streams;
