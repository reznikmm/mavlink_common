...
package Mavlink.V1.Common.Message.Set_Actuator_Control_Targets is

   pragma Preelaborate;

   Set_Actuator_Control_Target_Id : constant Msg_Id := 139;

   Set_Actuator_Control_Target_Len : constant Interfaces.Unsigned_8 := 43;

   type Set_Actuator_Control_Target is record
   ...
   for Set_Actuator_Control_Target use record
      ...
      Target_System    at 41 range 0 .. 7;
      Target_Component at 42 range 0 .. 7;
   end record;
