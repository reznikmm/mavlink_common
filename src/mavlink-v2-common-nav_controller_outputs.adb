...
package body MAVLink.V2.Common.Nav_Controller_Outputs is
   ...
   begin
      Last := Buffer'First +
        ...
        (Nav_Controller_Output'Value_Size / 8) - 1;
      Buffer (Buffer'First + Packet_Payload_First .. Last) := Local;
      Encode (Connect, Nav_Controller_Output_Id, 183, Sign, Buffer, Last);
   end Encode;
   ...
   is
      Data : Data_Buffer (1 .. Nav_Controller_Output'Value_Size / 8);
      Last : Natural;
      Buf  : Data_Buffer
...
end MAVLink.V2.Common.Nav_Controller_Outputs;
