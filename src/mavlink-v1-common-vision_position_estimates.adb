...
package body MAVLink.V1.Common.Vision_Position_Estimates is
   ...
   is
      Buf : Data_Buffer (1 .. Vision_Position_Estimate'Size / 8)
        with Import,
...
end MAVLink.V1.Common.Vision_Position_Estimates;
