...
package body MAVLink.V1.Common.Global_Position_Int_Covs is
   ...
   is
      Buf : Data_Buffer (1 .. Global_Position_Int_Cov'Size / 8)
        with Import,
        Address    => Message'Address,
        Convention => Ada;
   begin
      if Get_Msg_Len (Connect) =
        Unsigned_8 (Integer (Global_Position_Int_Cov'Value_Size) / 8)
      then
...
end MAVLink.V1.Common.Global_Position_Int_Covs;
